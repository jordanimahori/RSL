...
```{r}
input_data_path <- "Data/Test data/ICUMS DATA 2022/02. Merchandised Import (7)_NOV 2022.xlsx"

ouput_data_path <-"Output/Imports/output_Merchandised_imports_November_2022.xlsx"
```
...
colnames_1 <- c("head_time_proc", "del_1", "del_2", "head_cust_off_code", 
                ...
                "head_importer_code", "head_mode_trans_code", 
                "head_ctry_nat_vessel", "items_cpc_code", "items_hs_code", 
                "head_country_orig_dest", "items_net_mass", "items_gross_mass", 
                "items_qty", "country_of_consignment", "items_cif_ghc", 
                "items_insure_ghc", "items_freight_ghc", "del_3", 
                "items_fob_ghc", "items_supplementary1", "items_goods_desc", 
...
```{r}
# Need extra column names with empty cells
