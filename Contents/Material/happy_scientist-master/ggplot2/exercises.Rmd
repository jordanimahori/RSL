...
Replace this scatterplot with one that draws boxplots. Try typing "geom_" and hitting the tab button to see the functions that start with "geom_". Try to guess which one to use.
