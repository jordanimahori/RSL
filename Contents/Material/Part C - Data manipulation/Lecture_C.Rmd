...
asycuda[, 3]   # To select the third column
asycuda[4, 3]  # To select the element in row 4, column 3
```
- For a vector `my_vect`, the command `my_vect[n]` returns the n’th element.

- For a data.frame `my_df`, the command `my_df[n,m]` returns the n’th element of the m’th column
...
```{r}
asycuda_example <-
  read_excel("~/Projects/NRA/RSL/data/Import Export May 2022.xls", 
             guess_max = 100000) %>%
