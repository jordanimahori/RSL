...
- Introduction to data visualization:
  - [Lecture Data Visualisation](Contents/Material/Part E - Data visualization/Lecture_E_new.html){target="_blank"}
  - [Practical with ggplot](Contents/Material/Part E - Data visualization/Practical_E_webex_ggplot.html){target="_blank"}
...
| *Wednesday*  |   9.30 - 13.30  | CPI data visualizations |
|   |  14.15 - 17.00 | CPI data visualizations |
| *Thursday*  |   9.30 - 13.30    | More practicing |
