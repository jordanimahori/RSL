...
This dashboard covers the materials for the course introducing R. Course held in Ghana, December 12 - December 15, 2022.
...
| Day         | Hours       | Topic                               | 
|:------------|:------------|:------------------------------------|
| *Monday*    | 9.00-12.30 | Introduction to R and RStudio  (A)   |
|             | 13.30-17.00 | Basics of R (B) |
| *Tuesday*   | 9.00-12.00 | Data manipulation (C)               |
|             | 13.30-17.00 | Analyzing data (D)            |
| *Wednesday* | 9.00-12.30 | Visualizations (E)       |
|             | 13.30-17.00 | Q&A / Experimenting / Loops and functions (F)  |
...
### Additional material
Today we will see what is still outstanding and what else we can cover and not. Probably do the data visualiztion lectures
...
- ICUMS data 
  - Lecture?
  - Reformatting
- Cleaning and analyzing the ICUMS data
...
| Day         | Hours       | Topic                               | 
|:------------|:------------|:------------------------------------|
| *Thursday*  |  9.00 - 12.00  | Introduction to trade data |
|   |  13.00 - 16.30  | ICUMS data, reformatting |
| *Friday*  |    9.00 - 12.00  | Cleaning and analyzing ICUMS data |
|   |  13.00 - 16.30  | Working with the data! |
